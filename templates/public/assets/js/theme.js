...
var draggableInit = function draggableInit() {
  ...
  if (columnContainers.length) {
    ...
    }); // Place views and other contents bottom of the sortable container
...
var formValidationInit = function formValidationInit() {
  ...
  // Fetch all the views we want to apply custom Bootstrap validation styles to
...
var getTemplate = function getTemplate(event) {
  ...
  }).join(''), "\n            </ul>\n        </div>\n      ") : '', "\n  </div>\n</div>\n<div class=\"modal-footer d-flex justify-content-end bg-light px-card border-top-0\">\n  <a href=\"").concat(document.location.href.split('/').slice(0, 5).join('/'), "/app/events/create-an-event.html\" class=\"btn btn-falcon-default btn-sm\">\n    <span class=\"fas fa-pencil-alt fs--2 mr-2\"></span> Edit\n  </a>\n  <a href='").concat(document.location.href.split('/').slice(0, 5).join('/'), "/app/events/event-stream-statistics.html' class=\"btn btn-falcon-primary btn-sm\">\n    See more details\n    <span class=\"fas fa-angle-right fs--2 ml-1\"></span>\n  </a>\n</div>\n");
};
/* -------------------------------------------------------------------------- */
